...
class UserLoginData(Base):
    ...
    confirm_token: str = Column(String(200), nullable = False)
    confirm_token_time: str = Column(String(50), nullable = False)
    recovery_token: str = Column(String(200), nullable = False)
